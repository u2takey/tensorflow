...
#ifndef TENSORFLOW_CONTRIB_COS_COS_FILE_SYSTEM_H_
#define TENSORFLOW_CONTRIB_COS_COS_FILE_SYSTEM_H_
...
class CosFileSystem : public FileSystem {
 public:
  CosFileSystem();
  ~CosFileSystem();
 ...
 private:
  ...
  // for a bucket.
  std::shared_ptr<qcloud_cos::CosAPI> GetCosClient();
